  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><img src="/assest/Logo.jpg" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
            CLIV</a>
          ...
          <a class="btn btn-primary ms-3" href="/Register" role="button">SignUp </a>
        </div>
      </nav>
